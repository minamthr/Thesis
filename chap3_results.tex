...
Here the rest frequencies, the product of the line strength and the dipole moment ($S\mu^2$), the upper state energy ($E_{\mathrm{u}}$), the quantum numbers, and noise level are listed.
...
or their signal are below the noise level (See Appendix~B). 
...
the similar peak at or near Hot core.  CH$_3$NH$_2$ also shows the same trend.
...
In the integrated intensity map of 229.908 GHz line, emission comes from the southern part of Hot core (Figure \ref{fig:mom0s}).
...
These are also considered to be emission from other molecule lines 
