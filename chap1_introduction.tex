...
In addition, glycine reported in comet 67P/Churyumov-Gerasimenko by \citet{Altwegg+2016},
...
However, certain detection of glycine in molecular clouds has not been reported, 
...
388 $\pm$ 5 pc away from the sun \citep{Kounkel+2017}. 
Its proximity and rich molecular composition make this region well suited for astrochemical study.
Since this region was discovered in 1967, numerous studies including line survey have been conducted so far \citep[e.g.,][]{Pagani+2017, Feng+2015, Gong+2015, Turner1991}.

In Orion-KL, several remarkable sources called Hot core and Compact ridge are known as regions where many organic molecules exist. 
...
This object is a typical example of sources with many saturated molecules, called hot corino.
...
As opposed to hot corino, carbon chain molecules (e.g., CS, CCH) are detected in this source, and 
...
Since then, observations have been carried out at multiple wavelength such as X-rays and infrared, 
...
on the other hand, tit is not very suitable for the line survey because of low receiver flexibility. 
